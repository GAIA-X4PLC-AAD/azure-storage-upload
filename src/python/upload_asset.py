...
def upload_file_to_blob(file_path, sas_token, azure_storage_name, container_name):
    try:
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: python upload_asset.py <local_file_path_of_asset> <azure_storage_name> <source_container_name>")
        sys.exit(100)
    ...
    upload_file_to_blob(file_path, sas_token, azure_storage_name, container_name)
