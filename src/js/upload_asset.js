...
async function uploadFileToBlob(filePath, sasToken, azureStorageName, containerName) {
    try {
...
if (process.argv.length !== 5) {
    console.log('Usage: node upload_asset.js <local_file_path_of_asset> <azure_storage_name> <source_container_name>');
    process.exit(100);
}

const filePath = process.argv[2];
const azureStorageName = process.argv[3];
const containerName = process.argv[4];
